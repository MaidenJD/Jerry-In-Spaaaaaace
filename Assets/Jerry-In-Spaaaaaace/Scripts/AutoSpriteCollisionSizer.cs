...
public class AutoSpriteCollisionSizer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // yeah this one ain't me
        // changed it to use sprite renderer

        // Get triangles and vertices from mesh
        ushort[] triangles = spRenderer.sprite.triangles;
        Vector2[] vertices = spRenderer.sprite.vertices;
